...
def process_song_file(cur, filepath):
    """
    Description: This part performs ETL on the dataset, `song_data`,
...
def process_log_file(cur, filepath):
    """
    Description: This part performs ETL on the dataset, `log_data`,
    ...
    for index, row in df.iterrows():
        ...
        songplay_data = (row.ts, row.userID, row.level, row.songID, row.sessionID, row.location, row.userAgent)
